...
const elements2: GridItem[] = [
	{
		...
		action: { type: 'EXTERNAL_LINK', value: 'http://google.com?q=0' },
	...
	},
	{
		...
		action: { type: 'EXTERNAL_LINK', value: 'http://google.com?q=1' },
		buttonLabel: 'a button',
		buttonTitle: 'the button tooltip',
	...
	},
	{
		...
		action: { type: 'EXTERNAL_LINK', value: 'http://google.com?q=3' },
	},
	{
		...
		action: { type: 'EXTERNAL_LINK', value: 'http://google.com?q=4' },
	},
	{
		...
		action: { type: 'EXTERNAL_LINK', value: 'http://google.com?q=5' },
	},
	{
		source: '/images/500x200.svg?id=6',
		title: 'test title',
		text: 'test text',
		action: { type: 'EXTERNAL_LINK', value: 'http://google.com?q=6' },
	},
	{
		source: '/images/500x200.svg?id=7',
		title: 'test title',
		text: 'test text',
		action: { type: 'EXTERNAL_LINK', value: 'http://google.com?q=7' },
	},
	{
		source: '/images/500x200.svg?id=8',
		title: 'test title',
		text: 'test text',
		action: { type: 'EXTERNAL_LINK', value: 'http://google.com?q=8' },
	},
	{
...
const elements3: GridItem[] = [
	{
		source: '/images/500x200.svg?id=0',
		textAbove: 'meemoo',
		action: { type: 'EXTERNAL_LINK', value: 'http://google.com?q=9' },
	},
	{
		source: '/images/500x200.svg?id=1',
		textAbove: 'vlaamse overheid',
		action: { type: 'EXTERNAL_LINK', value: 'http://google.com?q=10' },
	},
];
