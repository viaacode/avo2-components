...
export const menuItemsWithSearch: MenuSearchResultItemInfoSchema[] = [
	{ label: 'WK Voetbal', id: 0, type: AvoContentTypeEnglish.COLLECTION, key: '0-collection' },
	{
		label: 'Wereldkampioenschap Voetbal 2018',
		id: 1,
		type: AvoContentTypeEnglish.COLLECTION,
		key: '1-collection',
	},
	{
		label: 'Journaal: voetbij bij jongeren',
		id: 2,
		type: AvoContentTypeEnglish.BUNDLE,
		key: '2-bundle',
	},
	{ label: 'Op één: voetbal', id: 3, type: AvoContentTypeEnglish.VIDEO, key: '3-video' },
	{
		label: 'Ketnet online: interview wereldbeker voetbal',
		id: 4,
		type: AvoContentTypeEnglish.AUDIO,
		key: '4-audio',
	},
];
