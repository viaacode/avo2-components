...
const Package = (props: SVGProps<SVGSVGElement>) => (
	...
	>
		...
		/>
		<path
			d="M12 12c-.153 0-.307-.035-.447-.105l-9.68-4.84a1 1 0 11.894-1.789L12 9.882l9.232-4.616a1 1 0 01.895 1.789l-9.68 4.84c-.14.07-.294.105-.447.105z"
			fill="#000"
		/>
		<path
			d="M12 23.76a1 1 0 01-1-1V11a1 1 0 012 0v11.76a1 1 0 01-1 1zM16.999 9.5c-.15 0-.303-.034-.446-.105l-10-5a1.001 1.001 0 01.894-1.789l10 5a1 1 0 01-.448 1.894z"
			fill="#000"
		/>
	</svg>
);
