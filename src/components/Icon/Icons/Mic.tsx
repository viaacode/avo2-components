...
export const Mic = (props: SVGProps<SVGSVGElement>) => (
	<svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
		...
		/>
		<path
			d="M12 20c-4.411 0-8-3.589-8-8v-2a1 1 0 012 0v2c0 3.309 2.691 6 6 6s6-2.691 6-6v-2a1 1 0 112 0v2c0 4.411-3.589 8-8 8z"
			fill="#000"
		/>
		<path d="M12 24a1 1 0 01-1-1v-4a1 1 0 112 0v4a1 1 0 01-1 1z" fill="#000" />
