...
const AlertTriangle = (props: SVGProps<SVGSVGElement>) => (
	<svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
		...
		/>
		<path
			d="M12 14a1 1 0 01-1-1V9a1 1 0 012 0v4a1 1 0 01-1 1zM12 18a.994.994 0 01-1-1c0-.13.03-.26.08-.38.05-.13.12-.23.21-.33.37-.37 1.04-.37 1.42 0 .09.1.16.21.21.33.05.12.08.25.08.38s-.03.26-.08.38-.12.229-.21.33A.994.994 0 0112 18z"
			fill="#000"
		/>
	</svg>
);
