...
export const Tag = (props: SVGProps<SVGSVGElement>) => (
	<svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
		...
		/>
		<path
			d="M7 8c-.26 0-.52-.11-.71-.29-.09-.1-.16-.21-.21-.33A.995.995 0 016 7c0-.13.03-.26.08-.38s.12-.23.21-.33c.1-.09.21-.16.33-.21a1 1 0 01.76 0c.12.05.23.12.33.21.18.19.29.45.29.71 0 .26-.11.52-.29.71-.19.18-.45.29-.71.29z"
			fill="#000"
		/>
	</svg>
);
